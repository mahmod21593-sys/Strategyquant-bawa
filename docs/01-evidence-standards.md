...
|---|---|---|---|
| **A** | Multiple peer-reviewed studies; several markets or asset classes; long samples; survives out-of-sample or post-publication; plausible mechanism | Time-series momentum in futures (Moskowitz, Ooi & Pedersen, 2012; Hurst, Ooi & Pedersen, 2017); market intraday momentum (Gao et al., 2018; Baltussen et al., 2021); turn-of-month (McConnell & Xu, 2008) | Standard funnel |
| **B** | Peer-reviewed but narrower (one market, one period, or a working paper), **or** documented partial decay, **or** strong mechanism with partial evidence | Index negative autocorrelation (Baltussen, van Bekkum & Da, 2019); ORB (Holmberg et al., 2013); FX time-of-day (Ranaldo, 2009); London-fix hedging flows (Melvin & Prins, 2015); rebalancing flows (Harvey, Mazzoleni & Melone, 2025) | Standard funnel **plus** pass on ≥ 3 markets or ≥ 2 sub-periods |
...
| **D** | Documented to have disappeared, or no mechanism | Pre-FOMC drift after 2015 (Kurov et al., 2021); overnight 2–3am ET drift after 2021 (NY Fed, 2026); weekday effects | Not traded. Kept as **decay controls** to calibrate how quickly edges die. |
